...
public class TabDepartmentAdapter extends IMSRecyclerView<Department>
{
    private Context context;
    private CallBack.With<Department> callBack;
    private int selectedTabPos = 0;

    public TabDepartmentAdapter(Context context, CallBack.With<Department> callBack)
    {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new TabDepartmentHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull IMSRecyclerView.ViewHolder holder, int position) {
        Department item = setSelectable(holder, position);
        ((TabDepartmentHolder)holder).bind(item);
    }

    public class TabDepartmentHolder extends ViewHolder<Department>
    {
        ...
        public TabDepartmentHolder(View view)
        {
            super(view);
        ...
        public void bind(Department item)
        {
            ...
            numTable.setText(String.format("(%s)",item.getNumTable()));
